...
http.createServer(function (request, response) {
    /*
    ,,request'' - strumień wejściowy - zawiera dane otrzymane od przeglądarki, np. zakodowaną zawartość pól formularza
   HTML
    ...
    */
    ...
    if (url_parts.pathname === '/submit') { //Przetwarzanie zawartości formularza, jeżeli względny URL to '/submit'
        ...
        console.log("Tworzenie nagłówka odpowiedzi");
        response.writeHead(200, {"Content-Type": "text/html; charset=utf-8"}); //Tworzenie nagłówka odpowiedzi -
